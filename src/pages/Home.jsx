    ...
    <div className={styles.home}>
      ...
      <div className={styles.features}>
        <div className={styles.featureCard}>
          ...
          <p>
            Только экологически чистые и натуральные ингредиенты в каждом
            продукте. Забота о вашем здоровье и окружающей среде.
          </p>
        </div>
        <div className={styles.featureCard}>
          <h3>💚 Партнерская программа</h3>
          <p>
            Выгодные условия для партнеров. Специальные цены и поддержка на всех
        ...
        <div className={styles.featureCard}>
          ...
          <p>
            Все продукты проходят строгий контроль качества. Мы гарантируем
