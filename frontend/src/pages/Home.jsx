...
const productsImages = [
  ...
  },
  {
    ...
    alt: 'Средства для ухода за телом',
    category: 'body-skin-care',
  },
  {
    src: product7,
    title: 'Средства для ухода за руками',
  ...
  },
  {
    ...
    alt: 'Средства гигиены полости рта',
  ...
  },
  {
    ...
    alt: 'Продукты для здоровья',
    category: 'health',
  },
  {
    src: product5,
    title: 'Продукция для детей',
    description: 'Экологически чистые средства для дома',
    alt: 'Эко средства для дома',
  ...
  {
    src: product10,
    title: 'Средства для ухода за кожей лица',
    description: 'Экологически чистые средства для дома',
    alt: 'Эко средства для дома',
    category: 'eco-friendly-home-remedies',
  },
